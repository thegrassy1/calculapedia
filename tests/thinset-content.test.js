...
assert.match(html, /Do not use a single bag estimate for both floor and wall work: measure and purchase for each trowel size separately, then round each material order up to whole bags/);
